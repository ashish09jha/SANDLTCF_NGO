    ...
    return (
        <div className="relative w-full py-12 mt-10">
            ...
            <div className="mx-auto text-center  items-center justify-center">
                <h2 className="font-raleway font-bold text-orange text-center items-center md:text-5xl text-4xl mt-16">About Founder</h2>
                <nav>
                    <p className="font-quicksand mt-4 text-white md:text-xl font-medium cursor-pointer mb-16 text-lg">
                        <Link to="/" >Home</Link> // <span className="text-orange">About Founder</span>
                    </p>
                </nav>
            </div>
        </div>
