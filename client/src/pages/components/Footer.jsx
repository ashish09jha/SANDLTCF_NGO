                ...
                <div className="container md:ml-0 ml-4 md:mx-auto md:flex md:justify-between md:mt-10 md:gap-6">
                    ...
                    <div className="md:w-1/3 text-center">
                        ...
                        <div className="grid md:grid-cols-1 grid-cols-2 gap-4 md:text-md text-sm md:ml-8">
                            {linkData.map((data, index) => (
                                <a key={index} href={data.href} className="font-quicksand flex items-center text-white text-md hover:text-orange  text-left">
                    ...
                    <div className="md:w-1/3 ">
                        ...
                        <div className='flex items-center md:mt-5 mt-1 md:mb-0 mb-10 text-white gap-6'>
                            <a href='https://web.facebook.com/profile.php?id=61553867905255' className='p-2 border border-orange rounded-full inline-block'>
                                <BsFacebook className='h-4 w-4 transition-transform transform hover:scale-110' />
                            </a>

                            <a href='https://www.instagram.com/restorationfoundation_int' className='p-2 border border-orange rounded-full inline-block'>
                                <BsInstagram className='h-4 w-4 transition-transform transform hover:scale-110' />
                            </a>
                            <a href='#' className='p-2 border border-orange rounded-full inline-block'>
                    ...
                    <div className="md:w-1/3 text-right">
                        ...
                        <form onSubmit={handleSave} className='md:mr-0 mr-24'>
                            <input
                                className='p-4 border border-orange rounded-md border-b-2 focus:outline-none font-quicksand w-72 '
                            ...
                            <button
                                type='submit'
                                className='p-4 bg-orange text-white hover:bg-primary hover:text-white mt-4 w-72 font-quicksand rounded-md text-center align-center justify-center items-center'
                            >
                                {!loading ? (
                                    "Submit"
                                ) : (
